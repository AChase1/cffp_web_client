...
class MoreColors extends ThemeExtension<MoreColors> {
  ...
  ThemeExtension<MoreColors> copyWith({
    ...
    return MoreColors(
        textFieldBackground: textFieldBackground ?? this.textFieldBackground, onTextFieldBackground: onTextFieldBackground ?? this.onTextFieldBackground);
  }

  @override
  ThemeExtension<MoreColors> lerp(covariant ThemeExtension<MoreColors>? other, double t) {
    if (other is! MoreColors) {
      return this;
    }
    return MoreColors(
      textFieldBackground: Color.lerp(textFieldBackground, other.textFieldBackground, t) as Color,
      onTextFieldBackground: Color.lerp(onTextFieldBackground, other.onTextFieldBackground, t) as Color,
    );
  }
}
