...
class UsernameInput extends ConsumerStatefulWidget {
  ...
  const UsernameInput({super.key, required this.onUpdate, required this.loginInfo});
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffix: usernameController.text.isNotEmpty ? UsernameClearButton(onClick: () => clearInput()) : const SizedBox(),
          fillColor: context.moreColors.textFieldBackground,
          error: Row(
            children: [
              Expanded(
